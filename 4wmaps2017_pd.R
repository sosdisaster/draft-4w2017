...
thismapfield <- "outpatient_consultations"
thismapname <- "Outpatient Consultations"
thismappalette  <- "PRGn"
thismapfilenamejpg <- "outpatient_consultations.jpg"
thismapfilenamepng <- "outpatient_consultations.png"
thismapfilenamehtm <- "outpatient_consultations.html"
